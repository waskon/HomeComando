    ...
    <main>
        ...
        <section class="notice-form">
            <form action="addNotice" method="POST" ENCTYPE="multipart/form-data">
                ...
                <div class="purpose-select purpose">
                    <select name="purpose" id="purposeType" class="form-control">
                ...
                LOCATION
                <div class="location">
                    <input class="title" name="street" type="text" placeholder="street">
                    <div>
                        <textarea name="house_number" rows=1 placeholder="house number"></textarea>
                        <textarea name="flat_number" rows=1 placeholder="flat number"></textarea>
                        <textarea name="postal_code" rows=1 placeholder="postal code"></textarea>
                        <textarea name="country" rows=1 placeholder="country"></textarea>
                    </div>
                </div>
